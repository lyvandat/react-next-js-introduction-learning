...
const MeetupDetail = props => {
  return /*#__PURE__*/Object(jsx_runtime_["jsxs"])("div", {
    ...
    children: [/*#__PURE__*/Object(jsx_runtime_["jsx"])("div", {
      className: MeetupDetail_module_default.a["img-wrapper"],
...
async function getStaticPaths() {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://lyvandat:0909927212aA@cluster0.lsg2quf.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
